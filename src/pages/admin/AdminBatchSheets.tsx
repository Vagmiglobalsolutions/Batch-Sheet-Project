...
const AdminBatchSheets = () => {
   ...
   *
   * The Batch Sheet modal lives inside the Admin layout,
   ...
   * containing ONLY the consolidated Batch Sheet modal.
   *
   * Therefore:
   *
  ...
  const handlePrint = (batch: BatchSheet) => {
    ...
    window.setTimeout(() => {
      ...
      // Clone ONLY the consolidated Batch Sheet modal.
      ...
      printWindow.document.write(`
        ...
        <html>
          <head>
            ...
            <title>
              ${batch.batchSheetNumber} - Batch Sheet
            </title>
      ...
      // original React Batch Sheet modal.
    ...
    <div className="admin-batch-page">
      <div className="admin-batch-page-header">
        <div>
          ...
          <p>
            Review complete
            integrated batch records
            received from Production
            after configured stages and
            QA/QC approvals.
          </p>
        </div>
      ...
      <section className="admin-batch-list-card">
        ...
        <div className="admin-batch-toolbar">
          <div className="admin-batch-search">
            <input
              type="text"
              placeholder="Search Batch Number, Product Code or Product Name"
              value={searchTerm}
              onChange={(event) =>
                setSearchTerm(
                  event.target.value
...
export default AdminBatchSheets;